...
<%
Doctor u1=DoctorDao.getRecordByPwd_admin(u.getadmin_pwd());
%>
...
<header class="header">
    ...
    <div class="navbar">
        <div class="menu1">
            <a href="PatientAllDetails.jsp">Patients</a>
            <a href="DoctorAllDetails.jsp">Doctors</a>
            <a href="AppointmentAllDetails.jsp">Appointments</a>
            <a href="DepartmentAllDetails.jsp">department</a>
          </div>  
          <div class="dropdown">
              <div class="dropbtn"><%= let %></div>
              <div class="dropdown-content">
                <a href="admin_profile.jsp?admin_id=<%= u1.getadmin_id() %>">My Profile</a>
