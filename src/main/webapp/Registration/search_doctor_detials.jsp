...
Doctor u=DoctorDao.getRecordByName(d_Name); 

%>   

<div class="btn"><button><a href="DoctorAllDetails.jsp">Back</a></button></div>
<div class="card">
    ...
    <section class="profile_container">
		...
		<div class="profile_desc_section">
            ...
            <table border='0' cellpadding="10px">
            	<tr>
            		<td style="font-weight:bold;">Id</td><td>: <%=u.getd_Id() %></td>
            	</tr><tr>
            		<td style="font-weight:bold;">Name</td><td>: <%=u.getd_Name() %></td>
            	</tr><tr>
            		<td style="font-weight:bold;">Email</td><td>: <%=u.getd_Email() %></td>
            	</tr><tr>
            		<td style="font-weight:bold;">Mobile No</td><td>: <%=u.getd_Mblno() %></td>
            	</tr><tr>
            		<td style="font-weight:bold;">Address</td><td>: <%=u.getd_Address() %></td>
    ...
    <!-- 
    <div class="edit">
    	<button type="edit"><a href="edit_profile.jsp?p_pwd=">Edit</a></button>
    </div>
     -->
